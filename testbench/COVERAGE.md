...
| Edit mode from the icon rail; no separate handoff button; pending annotations travel as chat context while questions leave edit mode active; hover flyout offers tools/exit; undo/redo and comments work | 05 | ✅ |
