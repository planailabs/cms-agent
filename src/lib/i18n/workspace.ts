...
export const workspaceCatalogs: AreaCatalogs = {
  en: {
    ...
    'workspace.window.headingManual': 'Window sessions',
    'workspace.window.button': 'Windows',
    'workspace.window.buttonTitle': 'Saved window sessions — restore or manage them',
    'workspace.window.none': 'No saved window sessions.',
  ...
  de: {
    ...
    'workspace.window.headingManual': 'Fenster-Sitzungen',
    'workspace.window.button': 'Fenster',
    'workspace.window.buttonTitle': 'Gespeicherte Fenster-Sitzungen — wiederherstellen oder verwalten',
    'workspace.window.none': 'Keine gespeicherten Fenster-Sitzungen.',
