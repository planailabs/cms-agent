  ...
  const panel = state.workspace.branchListOpen
    ? `<div class="ws-branch-panel">
        <div class="ws-branch-panel__actions">
          ...
          <button type="button" class="ws-mini-button" data-action="ws-caps-open" title="${escapeHtml(t(locale, 'workspace.sidebar.capsTitle'))}">${escapeHtml(t(locale, 'workspace.sidebar.capsButton'))}</button>
          <button type="button" class="ws-mini-button" data-action="ws-wsn-open" title="${escapeHtml(t(locale, 'workspace.window.buttonTitle'))}">${escapeHtml(t(locale, 'workspace.window.button'))}</button>
        </div>
